...
CREATE
SPATIAL INDEX IX_Location ON Institution(Location);
CREATE INDEX IX_Name ON Institution (Name);
CREATE INDEX IX_Code ON Institution (Code);
CREATE INDEX IX_SeoulCode ON Institution (SeoulCode);
END
